...
% x =[48.9196,1.4864,2.5901,0.9381,-0.1470,-0.0008,2.7621,2.0000,1.9383,-0.0080];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x =[2.1845,0.9615,0.6110,0.2024];  % 4个变量
% P_asterisk =13.1742;   L =1.0000;             delta =-2.3626e-005;  penaltyfun1 =0.0473;  penaltyfun2 =0;
% AR =2.9074;   Re =157.4793(123.0597);  penaltyfun5 =0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x=[3.004,0.8854,0.3289,0.356737];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 这组数据针对虚质量力负号多余和转动环量力矩(弦向轴)少了负号获得结果，不准确
% Rario_F_vertical_horiz_aver =1.3272;  F_vertical_to_horiz_rms =0.8432;
% P_aero_aver_to_inertia_aver =7.4469;  P_asterisk =29.6784;  L =1.2788;%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Rario_F_vertical_horiz_aver =1.1430; F_vertical_to_horiz_rms =0.8834;
% P_aero_aver_to_inertia_aver =8.4327;  P_asterisk =33.0097; L =1.2890;
% P_optimal=P_asterisk/(L^(3/2)); % P_optimal =22.5565;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % 下面的数据是实测原始翅膀形貌和翅膀运动计算而得——2016年1月6日论文审稿意见回来之前的数据
...
% L =1.3319;                  % 升重比
% AR =3.7643;               % 展弦比
% Re =172.8926(155.8311);           % 雷诺数
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x=[2.8194882e+000  1.0017584e+000  8.5611197e-002  9.1998796e-002];   % fval =17.8543;    % AR=2.9;
% AR=(x(1)+x(3))/x(2);  % AR=2.9;
% P_asterisk =17.8421;   L =1.0000;   delta =-6.0967e-006;
% penaltyfun1 =0.0122;  penaltyfun2 = 0;  obj_function =17.8543;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x =[2.8499,1.0314,0.1416,0.2958];  % fval =22.3771;  % AR =2.9004; 
% AR=(x(1)+x(3))/x(2)  % AR =2.9004; 
% P_asterisk =22.3606;  L =1.0000;  delta =-1.3906e-005;
% penaltyfun1 =0.0278;  penaltyfun2 =0;  penaltyfun5 =0;  obj_function =22.3884;
% x =[2.6843,0.9882,0.2315,0.1443];%  fval =21.1160; AR =2.9506; Re =168.8122;
x=[2.6842518e+000  9.8818826e-001  2.3149361e-001  1.4433740e-001]; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% tic
