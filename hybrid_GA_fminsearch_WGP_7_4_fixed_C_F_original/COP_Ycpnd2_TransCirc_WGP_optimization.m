function Y_rcpnd_Trans=COP_Ycpnd2_TransCirc_WGP_optimization(alpha,R_wing,xr0,C_maxyaxis)  % 输入变量不含有C_aver;
...
% d_cprnd=0.82*abs(alpha)/pi+0.05+dealta_x0/4-0.01334-0.01;  % wing_model_88_yaxis2_video_x_0_root_tip1@x_cop.xslx and z_cop.xslx
d_cprnd=0.82*abs(alpha)/pi+0.05+dealta_x0-0.01334-0.02; % wing_model_88_yaxis2_video_x_0_root_tip2 @x_cop2.xslx and z_cop2.xslx
%%%%%%%%%%%%%%%%%%%%%%%%%
