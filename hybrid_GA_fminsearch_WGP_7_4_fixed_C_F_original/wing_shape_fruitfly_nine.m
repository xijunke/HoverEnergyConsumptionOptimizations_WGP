function wing_para_output=wing_shape_fruitfly_nine()
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 求解——无量纲弦长分布多项式函数 ——计算有误——XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 有效力臂的无量纲位置Z_nd——计算有误——XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
% Z_rnd=double(int(yr_nd1,r_nd,0,1));                         % 输出: Y_nd=0.15341;  %  mm
...
wing_para_output=[R_wingeff,C_avereff,F_nd,Z_rnd,I_xzam,I_xxam,I3,I3z,I4z];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
