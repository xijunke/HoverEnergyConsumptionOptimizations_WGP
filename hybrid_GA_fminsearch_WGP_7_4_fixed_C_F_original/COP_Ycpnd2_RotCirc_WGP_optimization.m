function Y_rcpnd_rot=COP_Ycpnd2_RotCirc_WGP_optimization(alpha,R_wing,xr0,C_maxyaxis)   % 输入变量不含有C_aver;
...
% d_cprnd=0.82*abs(alpha)/pi+0.05+dealta_x0/4-0.005;  % wing_model_88_yaxis2_video_x_0_root_tip1@x_cop.xslx and z_cop.xslx
d_cprnd=0.82*abs(alpha)/pi+0.05+dealta_x0-0.015; % wing_model_88_yaxis2_video_x_0_root_tip2 @x_cop2.xslx and z_cop2.xslx
%%%%%%%%%%%%%%%%%%%%%%%%%
