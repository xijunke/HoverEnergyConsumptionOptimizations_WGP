...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 方案1——不设置初始值
% x=[45.4147,1.5696,1.8489,1.0385,-0.9685,-0.0463,3.5193,1.8689,1.3038,-0.0008]; % 初始种群1 % 10个变量
% P_asterisk =6.9607;     L =1.0002;   delta =1.6715e-004;   penaltyfun1 =0.3343; 
% penaltyfun2 =4.5714;   AR =2.5807;   Re =126.7144;     penaltyfun5 =0;
% x=[45.4271,1.5679,1.8515,1.0364,-0.9666,-0.0470,3.5258,1.8657,1.3081,0.0122];  % 初始种群2 % 10个变量
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x_start=[2.4694,0.9595,0.3687,0.0887]; 
x_start =[2.453,0.972,0.3658,0.0878];
options=gaoptimset('Display','iter','PopulationSize',100,'InitialPopulation',x_start,'Generations',5,...   % 继续遗传5代+1600代局部搜索
    'PlotFcns',{@gaplotbestf,@gaplotexpectation,@gaplotstopping,@gaplotbestindiv,@gaplotscores,@gaplotrange},...
    'TolCon',1e-15,'TolFun',1e-15,'UseParallel','always'); %并行计算——可行
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fminsearchoptions =
...
% fminsearchoptions=optimset('Display','iter-detailed',...
%                                  'MaxFunEvals',1000,'MaxIter',1000,'TolX',1e-15,'TolFun',1e-15,'UseParallel','always'); % 初始搜索2
% fminsearchoptions=optimset('Display','iter-detailed','TolX',1e-15,'TolFun',1e-15,'UseParallel','always'); % 初始搜索3
fminsearchoptions=optimset('Display','iter-detailed','MaxFunEvals',1600,'MaxIter',1600,'TolX',1e-15,'TolFun',1e-15,'UseParallel','always'); % 初始搜索4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% xlswrite('D:\cal_result\hybrid_GA_fminsearch_WKP_7_4_fixed_C_F_2\population_scores.xlsx',output_1,'sheet1','A1:E100');
xlswrite('population_scores.xlsx',output_1,'sheet1','A1:E100');
