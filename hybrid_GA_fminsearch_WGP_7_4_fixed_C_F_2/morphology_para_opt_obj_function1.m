...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% x =[2.4694,0.9595,0.3687,0.0887];  % fval =20.8110;  AR =2.9580;
% P_asterisk =20.8113;   L =1.0001;      delta =7.5094e-005;
% penaltyfun1 =0.1502;   penaltyfun2 =0;   penaltyfun5 =0; obj_function =20.9615;
% x =[2.453,0.972,0.3658,0.0878]; % fval =20.6299; P_asterisk =20.6269; L =0.9999; delta =-1.1455e-004;AR =2.9000;Re =160.5336;
% x =[2.4370,0.9626,0.3574,0.0000]; % fval =20.4839; AR =2.9029; Re =157.6046;
x =[2.4370405e+000  9.6264170e-001  3.5736539e-001  5.3735407e-012]; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % 下面的数据是实测原始翅膀形貌和翅膀运动计算而得——2016年1月6日论文审稿意见回来之后的数据
% P_asterisk =33.0097; % 功率密度
% L =1.2890;                 % 升重比 
% AR =3.7643;              % 展弦比
% Re =172.8926(155.8311);  % 雷诺数
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
